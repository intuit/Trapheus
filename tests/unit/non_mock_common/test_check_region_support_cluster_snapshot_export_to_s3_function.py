...
import constants
from export.copy_across_regions import check_region_support_cluster_snapshot_export_to_s3_function

os.environ["Region"] = "us-west-2"
os.environ["ExportSnapshotSupportedRegion"] = "eu-west-1"


class TestCheckRegionSupportClusterSnapshotExportToS3Function(TestCase):
    ...
    def test_lambda_check_region_support_snapshot_export_to_s3_supports(self, mock_supports_snapshot_export_region):
        result = check_region_support_cluster_snapshot_export_to_s3_function.lambda_check_region_support_cluster_snapshot_export_to_s3(
            self.event, {})
    ...
    @patch("utility.get_cluster_snapshot_arn", return_value="testarn")
