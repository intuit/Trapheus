...
from export.copy_across_regions import copy_cluster_snapshot_to_s3_export_supportable_region_function

export_snapshot_supported_region = "eu-west-1"
mock_status = 'mock_status'
os.environ["Region"] = "us-west-2"
os.environ['SNAPSHOT_COPY_EXPORT_TASK_KEY'] = "test_copy_key"
copy_db_cluster_snapshot_response = {
    'DBClusterSnapshot': {
        'Status': mock_status,
    }
}
...
class TestCopyClusterSnapshotToS3ExportSupportableRegionFunction(TestCase):
    def setUp(self):
        self.event = create_event()

    @patch("utility.get_instance_snapshot_arn", return_value="testarn")
    @patch("export.copy_across_regions.copy_cluster_snapshot_to_s3_export_supportable_region_function.boto3.client")
    @patch("export.copy_across_regions.copy_cluster_snapshot_to_s3_export_supportable_region_function.copy_db_cluster_snapshot",
           return_value=copy_db_cluster_snapshot_response)
    def test_lambda_copy_snapshot_to_s3_export_supportable_region_boto3_client_takes_proper_region(self
                                                                                                   ...
                                                                                                   , mock_boto3_client
                                                                                                   , mock_copy_db_cluster_snapshot
                                                                                                   ):
        copy_cluster_snapshot_to_s3_export_supportable_region_function.lambda_copy_cluster_snapshot_to_s3_export_supportable_region(
            self.event, {})
    ...
    def test_lambda_copy_snapshot_to_s3_export_supportable_region_success(self
        ...
        result = copy_cluster_snapshot_to_s3_export_supportable_region_function. \
            lambda_copy_cluster_snapshot_to_s3_export_supportable_region(self.event, {})
    ...
    def test_lambda_copy_snapshot_to_s3_export_supportable_region_empty_export_snapshot_supported_region(self
        ...
        with self.assertRaises(custom_exceptions.ExportSnapshotSupportedRegionNotProvidedException) as err:
            copy_cluster_snapshot_to_s3_export_supportable_region_function. \
                lambda_copy_cluster_snapshot_to_s3_export_supportable_region(self.event, {})
