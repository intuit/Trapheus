...
class TestExportSnapshotS3Function(unittest.TestCase):
    ...
    @patch("utility.get_aws_account_id", return_value="1231231234")
    def test_lambda_export_rds_snapshot_to_s3_bad(self, mock_get_aws_account_id, mock_client):
        mock_rds = mock_client.return_value
    ...
    @patch("utility.get_aws_account_id", return_value="1231231234")
    def test_lambda_export_rds_snapshot_to_s3_bad_bucket_deleted(self, mock_get_aws_account_id, mock_client):
        mock_rds = mock_client.return_value
    ...
    def test_get_snapshot_arn_notavailable(self, mock_client):
